 ...
 * @email          :  
 * @repo           :  
 * @createdOn      :  2025-1-25 15:31:25
 * @description    :  6ull led drivers
 *------------------------------------------------------------------------**/
...
static struct platform_device dev_gpio5 = {
    .name = "gpio5_led",
...
{
    int err;
    err = platform_device_register(&dev_gpio5);
...
{
    platform_device_unregister(&dev_gpio5);
}
